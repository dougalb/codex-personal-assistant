...
2. Complete `context/profile.md`, `context/source-of-truth.md`, `context/source-registry.md`, `context/data-policy.md`, and `context/action-policy.md`.
...
6. After valid durable knowledge changes, run `python3 .codex/tools/knowledge_bundle.py audit` followed by `git pa-checkpoint`. It never pushes; use `git revert` for human-requested rollback.
