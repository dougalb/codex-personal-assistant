...
Each concept is a Markdown file with JSON-compatible YAML frontmatter. Keep only distilled facts, source locators, timestamps, and provenance. Relative paths are identities and normal Markdown links are graph edges. Never store raw connector archives here.
